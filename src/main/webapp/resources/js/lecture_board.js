$(document).ready(function() {
	...
	$('#boardMod_btn').bind('click', function() {
		boardMod();
	});

	$('#boardDel_btn').bind('click', function() {
		boardDel();
	});

	$('#boardRep_btn').bind('click', function() {
		boardReport();
	});
...
var boardReDeleteAjax = function(reply_id) {
	$.ajax({
		type: "POST",
		url: "/lecture/boardConfirm",
		dataType: "json",
...
var boardReReportAjax = function(reply_id) {
